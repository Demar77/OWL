...
namespace TooExe.Owl.Mvc.Migrations
{
    ...
    [Migration("20170406210433_AddRelationKnowWord_OwlUser")]
    partial class AddRelationKnowWord_OwlUser
    {
            ...
            modelBuilder.Entity("TooExe.Owl.Library.Model.KnownWord", b =>
                {
                    ...
                    b.Property<int?>("OwlUserId");

                    b.HasKey("Id");

                    b.HasIndex("IdTranslation");

                    b.HasIndex("OwlUserId");
            ...
            modelBuilder.Entity("TooExe.Owl.Library.Model.KnownWord", b =>
                {
                    ...
                    b.HasOne("TooExe.Owl.Library.Model.OwlUser")
                        .WithMany("KnownWords")
                        .HasForeignKey("OwlUserId");
                });
